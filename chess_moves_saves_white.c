...
//            printf("1>\n");
            ...
            save->moveY = save->Y - 1;
            save->done = 0;
        } else if (save->moveX > 0 && save->moveY < 7 &&
                   peice_number_is_black(get_piece(board, save->X - 1, save->Y - 1))) {
//            printf("2>\n");
            save->moveX = save->X - 1;
            save->moveY = save->Y - 1;
            save->done = 0;
        } else if (save->moveY < 7 &&
...
//            printf("1>\n");
            save->moveX = save->X + 1;
        } else if (save->moveX > 0 && !peice_number_is_white(get_piece(board, save->X - 1, save->Y))) {
//            printf("2>\n");
            save->moveX = save->X - 1;
...
//            printf("3>\n");
            save->moveX = save->X;
            save->moveY = save->Y + 1;
        } else if (save->moveY > 0 && !peice_number_is_white(get_piece(board, save->X, save->Y - 1))) {
//            printf("4>\n");
            save->moveX = save->X;
            save->moveY = save->Y - 1;
        } else {
